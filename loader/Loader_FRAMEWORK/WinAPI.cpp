...
{
callWinAPIFunction(/*gdiplus.dll*/XorStr<0xEE, 12, 0x443F65C2>("\x89\x8B\x99\x81\x9E\x86\x87\xDB\x92\x9B\x94" + 0x443F65C2).s,/*GdiplusStartup*/XorStr<0x33, 15, 0x0EB72010>("\x74\x50\x5C\x46\x5B\x4D\x4A\x69\x4F\x5D\x4F\x4A\x4A\x30" + 0x0EB72010).s, 3, output, input, token);
}
